...
AssetLoad.prototype = Object.create(EventDispatcher.prototype);
 ...
 */
AssetLoad.prototype._applyDefaults = function(asset)
{
 ...
 */
AssetLoad.prototype.taskDone = function(task, result)
{
 ...
 */
AssetLoad.prototype._getAssetsContainer = function(mode)
{
    switch (mode)
    {
        case AssetLoad.SINGLE_MODE:
