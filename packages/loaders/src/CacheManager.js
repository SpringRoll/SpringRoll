 ...
 * @default false
 */
Object.defineProperty(CacheManager.prototype, "cacheBust",
{
    get: function()
    {
 ...
 */
CacheManager.prototype.addVersionsFile = function(url, callback, baseUrl)
{
    // @if DEBUG
 ...
 */
CacheManager.prototype.addVersion = function(url, version)
{
 ...
 */
CacheManager.prototype.unregisterURLFilter = function(filter)
{
 ...
 */
CacheManager.prototype._applySpecificVersion = function(url)
{
 ...
 * @return {String} The modified url.
 */
CacheManager.prototype._applyGlobalVersion = function(url)
{
 ...
 */
CacheManager.prototype.prepare = function(url, applyBasePath)
{
