 ...
 * @default null
 */
State.prototype.exit = State.empty;
 ...
 * @default null
 */
State.prototype.exitStart = State.empty;
 ...
 * @default null
 */
State.prototype.cancel = State.empty;
 ...
 * @default null
 */
State.prototype.enter = State.empty;
 ...
 * @default null
 */
State.prototype.enterDone = State.empty;
 ...
 * @final
 */
State.prototype.loadingStart = function()
{
    if (this._isLoading)
    {
 ...
 */
State.prototype.loadingDone = function(delay)
{
    if (delay === undefined)
    {
 ...
 * @readOnly
 */
Object.defineProperty(State.prototype, 'canceled',
{
    get: function()
    {
 ...
 */
Object.defineProperty(State.prototype, 'enabled',
{
    get: function()
    {
 ...
 * @readOnly
 */
Object.defineProperty(State.prototype, 'destroyed',
{
    get: function()
    {
 ...
 * @protected
 */
State.prototype._internalExit = function()
{
    this.preloaded = false;
 ...
 * @protected
 */
State.prototype._internalEntering = function()
{
    this.enter();
 ...
 */
State.prototype._onProgress = function(progress)
{
 ...
 */
State.prototype._onLoaded = function(assets)
{
    this.assets = assets;
    this.preloaded = true;
 ...
 * @protected
 */
State.prototype._internalExitStart = function()
{
    this.exitStart();
 ...
 * @protected
 */
State.prototype._internalEnter = function(proceed)
{
    if (this._isTransitioning)
    {
        this._isTransitioning = false;
 ...
 * @protected
 */
State.prototype._internalCancel = function()
{
    this._active = false;
    this._canceled = true;
    this._isLoading = false;
 ...
 * @private
 */
State.prototype._internalEnterDone = function()
{
