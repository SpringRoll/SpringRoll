...
StateManager.prototype = Object.create(EventDispatcher.prototype);
 ...
 */
StateManager.prototype.addState = function(id, state)
{
    // @if DEBUG
 ...
 */
StateManager.prototype.isBusy = function()
{
 ...
 * @method loadingStart
 */
StateManager.prototype.loadingStart = function()
{
 ...
 * @method loadingDone
 */
StateManager.prototype.loadingDone = function()
{
    if (this._destroyed) return;
 ...
 */
Object.defineProperty(StateManager.prototype, 'enabled',
{
 ...
 * @private
 */
StateManager.prototype._onTransitionOut = function()
{
 ...
 * @private
 */
StateManager.prototype._onStateLoaded = function()
{
    this._isLoading = false;
    this._isTransitioning = true;
 ...
 * @private
 */
StateManager.prototype._onTransitionIn = function()
{
    if (this.transition)
    {
 ...
 * @private
 */
StateManager.prototype._onTransitionLoading = function()
{
 ...
 */
StateManager.prototype.showTransitionOut = function(callback)
{
    this.enabled = false;
 ...
 * @param {function} callback The function to call when the animation is complete.
 */
StateManager.prototype.showTransitionIn = function(callback)
{
 ...
 * @private
 */
StateManager.prototype._transitioning = function(event, callback)
{
