 ...
 * @default false
 */
Object.defineProperty(Captions.prototype, 'mute',
{
    get: function()
    {
        return this._mute;
 ...
 * @default true
 */
Object.defineProperty(Captions.prototype, 'selfUpdate',
{
 ...
 */
Object.defineProperty(Captions.prototype, 'data',
{
    set: function(dict)
    {
        this._data = dict;
 ...
 */
Object.defineProperty(Captions.prototype, 'textField',
{
    set: function(field)
    {
 ...
 */
Captions._setText = function(field, text)
{
    if (!field) return;
 ...
 */
Captions.prototype.hasCaption = function(alias)
{
 ...
 */
Captions.prototype.getFullCaption = function(alias, separator)
{
 ...
 */
Captions.prototype._load = function(data)
{
 ...
 * @method _reset
 */
Captions.prototype._reset = function()
{
    this._currentLine = -1;
    this._lastActiveLine = -1;
};
 ...
 */
Captions._timeCodeToMilliseconds = function(input)
{
 ...
 * @readOnly
 */
Object.defineProperty(Captions.prototype, 'playing',
{
    get: function()
    {
 ...
 */
Captions.prototype._getTotalDuration = function()
{
 ...
 * @readOnly
 */
Object.defineProperty(Captions.prototype, 'currentDuration',
{
    get: function()
    {
 ...
 * @readOnly
 */
Object.defineProperty(Captions.prototype, 'currentAlias',
{
    get: function()
    {
 ...
 */
Captions.prototype.play = function(alias, callback)
{
    this.stop();
 ...
 * @method stop
 */
Captions.prototype.stop = function()
{
    this._playing = false;
 ...
 */
Captions.prototype.seek = function(time)
{
 ...
 */
Captions.prototype._updatePercent = function(progress)
{
    if (this._destroyed)
        return;
 ...
 */
Captions.prototype.update = function(elapsed)
{
 ...
 * @method _calcUpdate
 */
Captions.prototype._calcUpdate = function()
{
    var lines = this._lines;
    if (!lines)
        return;
 ...
 */
Captions.prototype._updateCaptions = function()
{
    Captions._setText(
        this._textField, //
 ...
 */
Captions.prototype.getLength = function(alias)
{
    var length = 0;
    if (Array.isArray(alias))
    {
 ...
 * @method destroy
 */
Captions.prototype.destroy = function()
{
    if (this._destroyed)
        return;
