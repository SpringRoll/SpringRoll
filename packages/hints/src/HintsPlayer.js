...
HintsPlayer.prototype = Object.create(EventDispatcher.prototype);
 ...
 */
HintsPlayer.prototype.vo = function(idOrList, onComplete, onCancel)
{
 ...
 */
HintsPlayer.prototype.anim = function(instance, events, onComplete, onCancel)
{
 ...
 */
HintsPlayer.prototype.func = function(onStart)
{
 ...
 */
HintsPlayer.prototype.group = function()
{
 ...
 */
HintsPlayer.prototype.set = function(hint)
{
 ...
 * @method clear
 */
HintsPlayer.prototype.clear = function()
{
    this._playing = false;
    this.removeTimer();
    this.enabled = false;
 ...
 */
HintsPlayer.prototype.play = function()
{
    if (this._hint)
    {
 ...
 * @return {springroll.HintsPlayer} instance of the player for chaining
 */
HintsPlayer.prototype.startTimer = function(duration)
{
 ...
 * @return {springroll.HintsPlayer} instance of the player for chaining
 */
HintsPlayer.prototype.stopTimer = HintsPlayer.prototype.removeTimer = function()
{
 ...
 * @return {springroll.HintsPlayer} instance of the player for chaining
 */
HintsPlayer.prototype.resetTimer = function()
{
    this._app.off('update', this._update).on('update', this._update);
 ...
 */
Object.defineProperty(HintsPlayer.prototype, 'enabled',
{
 ...
 */
HintsPlayer.prototype._update = function(elapsed)
{
 ...
 * @param {Boolean} [cancelled=false] If the function was interrupted by the user or something else.
 */
HintsPlayer.prototype.funcDone = HintsPlayer.prototype._done = function(cancelled)
{
    this._playing = false;
    this.resetTimer();
 ...
 * @private
 */
HintsPlayer.prototype._clearOldHints = function()
{
 ...
 * @method destroy
 */
HintsPlayer.prototype.destroy = function()
{
    this.clear();
    this._clearOldHints();
    this._app = null;
