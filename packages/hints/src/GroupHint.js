...
GroupHint.prototype = Object.create(AbstractHint.prototype);

/**
 * Run the hint
 * @method play
 */
GroupHint.prototype.play = function()
{
 ...
 */
GroupHint.prototype.vo = function(idOrList, onComplete, onCancel)
{
 ...
 */
GroupHint.prototype.anim = function(instance, events, onComplete, onCancel)
{
 ...
 */
GroupHint.prototype.func = function(onStart)
{
 ...
 */
GroupHint.prototype.addTier = function()
{
    this._tier = [];
 ...
 * @return {springroll.GroupHint} The instance of the group hint, for chaining
 */
GroupHint.prototype.nextTier = function()
{
 ...
 */
GroupHint.prototype.reset = function()
{
    this._current = -1;
    this.nextTier();
};
 ...
 * @method destroy
 */
GroupHint.prototype.destroy = function()
{
    this._tiers = null;
    this._tier = null;
    this._current = -1;
