...
// @if DEBUG
ScaleItem.prototype.toString = function()
{
 ...
 * @readOnly
 */
Object.defineProperty(ScaleItem.prototype, 'display',
{
    get: function()
    {
 ...
 */
ScaleItem.prototype.resize = function(displayWidth, displayHeight)
{
 ...
 * @method destroy
 */
ScaleItem.prototype.destroy = function()
{
    this._adapter = null;
