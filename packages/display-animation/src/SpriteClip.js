 ...
 *                                                cache.
 */
var SpriteClip = function(data, atlas)
{
...
SpriteClip.prototype = Object.create(PIXI.Sprite.prototype);
 ...
 * @default 0
 */
Object.defineProperty(SpriteClip.prototype, 'framerate',
{
    get: function()
    {
 ...
 * @public
 */
Object.defineProperty(SpriteClip.prototype, 'elapsedTime',
{
    get: function()
    {
        return this._t;
 ...
 * @readOnly
 */
Object.defineProperty(SpriteClip.prototype, 'totalFrames',
{
    get: function()
    {
 ...
 * @method advance
 */
SpriteClip.prototype.advance = function(time)
{
 ...
 *                        properties.
 */
SpriteClip.prototype.getLabels = function()
{
    return this._labels;
};
 ...
 *    properties.
 */
SpriteClip.prototype.getEvents = function()
{
    return this._events;
};
 ...
 */
SpriteClip.prototype.getCurrentLabel = function()
{
    var labels = this._labels;
    var current = null;
    for (var i = 0, len = labels.length; i < len; ++i)
 ...
 *                                               cache.
 */
SpriteClip.prototype.init = function(data, atlas)
{
...
Sprite.prototype._labelSorter = function(a, b)
{
    return a.position - b.position;
};

Sprite.prototype._getFrames = function(name, numberMin, numberMax, maxDigits, outArray)
{
 ...
 */
SpriteClip.prototype.copyFrom = function(other)
{
 ...
 *    @method destroy
 */
SpriteClip.prototype.destroy = function()
{
