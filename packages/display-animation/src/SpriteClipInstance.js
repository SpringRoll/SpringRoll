 ...
 * @private
 */
var SpriteClipInstance = function()
{
...
SpriteClipInstance.prototype = Object.create(AnimatorInstance.prototype);
 ...
 */
SpriteClipInstance.prototype.init = function(clip)
{
...
SpriteClipInstance.prototype.beginAnim = function(animObj, isRepeat)
{
 ...
 * @method endAnim
 */
SpriteClipInstance.prototype.endAnim = function()
{
 ...
 */
SpriteClipInstance.prototype.setPosition = function(newPos)
{
 ...
 */
SpriteClipInstance.test = function(clip)
{
 ...
 */
SpriteClipInstance.getDuration = function(clip, event)
{
 ...
 * @method destroy
 */
SpriteClipInstance.prototype.destroy = function()
{
    this.clip = null;
};

export default SpriteClipInstance;
