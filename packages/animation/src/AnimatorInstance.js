 ...
 */
AnimatorInstance.prototype.init = function(clip)
{
    this.clip = clip;
};
 ...
 */
AnimatorInstance.prototype.beginAnim = function(animObj, isRepeat) {};

/**
 * Ends animation playback.
 * @method endAnim
 */
AnimatorInstance.prototype.endAnim = function() {};
 ...
 */
AnimatorInstance.prototype.setPosition = function(newPos) {};
 ...
 * @method destroy
 */
AnimatorInstance.prototype.destroy = function()
{
    this.clip = null;
};
