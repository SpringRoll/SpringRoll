...
GenericMovieClipInstance.prototype = Object.create(AnimatorInstance.prototype);
 ...
 */
GenericMovieClipInstance.prototype.init = function(clip)
{
...
GenericMovieClipInstance.prototype.beginAnim = function(animObj, isRepeat)
{
 ...
 * @method endAnim
 */
GenericMovieClipInstance.prototype.endAnim = function()
{
 ...
 */
GenericMovieClipInstance.prototype.setPosition = function(newPos)
{
 ...
 * @method destroy
 */
GenericMovieClipInstance.prototype.destroy = function()
{
    this.clip = null;
};

export default GenericMovieClipInstance;