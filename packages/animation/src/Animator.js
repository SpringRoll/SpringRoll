 ...
 */
Animator.prototype.register = function(qualifiedClassName, priority)
{
 ...
 * @return {springroll.AnimatorTimeline} The Timeline object that represents this play() call.
 */
Animator.prototype.play = function(clip, eventList, onComplete, onCancelled)
{
    var audio, options;
 ...
 * @private
 */
Animator.prototype._makeTimeline = function(clip, eventList, onComplete, onCancelled)
{
 ...
 */
Animator.prototype.canAnimate = function(clip)
{
    if (!clip)
    {
        return false;
 ...
 */
Animator.prototype.hasAnimation = function(clip, event)
{
    var Definition = getDefinitionByClip(clip);
    if (!Definition)
    {
 ...
 */
Animator.prototype.getDuration = function(clip, event)
{
    var Definition = getDefinitionByClip(clip);
    if (!Definition)
    {
 ...
 */
Animator.prototype.stop = function(clip, removeCallbacks)
{
 ...
 */
Animator.prototype.stopAll = function(container, removeCallbacks)
{
    if (!this._hasTimelines)
    {
        return;
 ...
 * @private
 */
Animator.prototype._remove = function(timeline, doCancelled)
{
 ...
 */
Animator.prototype.pauseInGroup = function(paused, container)
{
 ...
 */
Animator.prototype.getTimeline = function(clip)
{
    if (!this._hasTimelines)
    {
        return null;
 ...
 * @private
 */
Animator.prototype._startUpdate = function()
{
 ...
 * @private
 */
Animator.prototype._stopUpdate = function()
{
 ...
 * @private
 */
Animator.prototype._update = function(elapsed)
{
 ...
 * @param {int} playIndex
 */
Animator.prototype._onSoundStarted = function(timeline, playIndex)
{
 ...
 */
Animator.prototype._onSoundDone = function(timeline, playIndex, soundAlias)
{
