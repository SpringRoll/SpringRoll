...
var CordovaAudioPlugin = include('createjs.CordovaAudioPlugin', false);
var FlashAudioPlugin = include('createjs.FlashAudioPlugin', false);
var SoundJS = include('createjs.Sound');
...
Sound._fixAudioContext = function()
{
 ...
 */
Sound.prototype._initComplete = function(filetypeOrder, callback)
{
 ...
 */
Sound.prototype.addContext = function(config)
{
    if (!config)
    {
        if (DEBUG && Debug)
 ...
 */
Sound.prototype.linkContexts = function(parent, subContext)
{
 ...
 * @return {Boolean} true if the sound exists, false otherwise.
 */
Sound.prototype.exists = function(alias)
{
 ...
 */
Sound.prototype.contextExists = function(context)
{
 ...
 */
Sound.prototype.isUnloaded = function(alias)
{
 ...
 */
Sound.prototype.isLoaded = function(alias)
{
 ...
 */
Sound.prototype.isPlaying = function(alias)
{
 ...
 */
Sound.prototype.getDuration = function(alias)
{
    var sound = this._sounds[alias];
 ...
 */
Sound.prototype.fadeIn = function(aliasOrInst, duration, targetVol, startVol)
{
    var sound, inst;
 ...
 */
Sound.prototype._update = function(elapsed)
{
 ...
 */
Sound.prototype.play = function(alias, options, startCallback, interrupt, delay, offset, loop, volume, pan)
{
 ...
 */
Sound.prototype._getSoundInst = function(channel, id)
{
    var rtn;
 ...
 */
Sound.prototype._onSoundComplete = function(inst)
{
    if (inst._channel)
    {
        if (this._fixAndroidAudio)
 ...
 */
Sound.prototype.stop = function(alias)
{
 ...
 */
Sound.prototype._stopSound = function(s)
{
    var arr = s.playing;
 ...
 */
Sound.prototype._stopInst = function(inst)
{
    if (inst._channel)
    {
 ...
 */
Sound.prototype.stopContext = function(context)
{
 ...
 */
Sound.prototype.pause = function(sound, isGlobal)
{
 ...
 *     Internally, this can also be the object from the _sounds dictionary directly.
 */
Sound.prototype.resume = function(sound, isGlobal)
{
    if (typeof sound === "string")
        sound = this._sounds[sound];
    var arr = sound.playing;
 ...
 */
Sound.prototype.pauseContext = function(context)
{
    context = this._contexts[context];
    if (context)
    {
 ...
 * @param {String} context The name of the context to pause.
 */
Sound.prototype.resumeContext = function(context)
{
    context = this._contexts[context];
    if (context)
    {
 ...
 * @public
 */
Sound.prototype.resumeAll = function()
{
    var arr = this._sounds;
    for (var i in arr)
...
Sound.prototype._onInstancePaused = function()
{
    if (this._fixAndroidAudio)
    {
        if (--this._numPlayingAudio === 0)
...
Sound.prototype._onInstanceResume = function()
{
    if (this._fixAndroidAudio)
    {
        if (this._lastAudioTime > 0 && Date.now() - this._lastAudioTime > 30000)
 ...
 */
Sound.prototype.setContextMute = function(context, muted)
{
    context = this._contexts[context];
    if (context)
    {
 ...
 */
Sound.prototype.setContextVolume = function(context, volume)
{
    context = this._contexts[context];
    if (context)
    {
 ...
 */
Sound.prototype.preload = function(list, callback)
{
    if (!this.isSupported)
    {
        if (callback)
 ...
 */
Sound.prototype._markLoaded = function(result)
{
 ...
 */
Sound.prototype.unload = function(list)
{
    if (!list) return;
 ...
 * @public
 */
Sound.prototype.unloadAll = function()
{
    var arr = [];
