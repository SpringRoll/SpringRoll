...
VOPlayer.prototype = Object.create(EventDispatcher.prototype);
 ...
 * @readOnly
 */
Object.defineProperty(VOPlayer.prototype, "playing",
{
    get: function()
    {
 ...
 * @readOnly
 */
Object.defineProperty(VOPlayer.prototype, "currentVO",
{
    get: function()
    {
 ...
 * @public
 */
Object.defineProperty(VOPlayer.prototype, "captions",
{
 ...
 */
Object.defineProperty(VOPlayer.prototype, "currentPosition",
{
    get: function()
    {
 ...
 */
Object.defineProperty(VOPlayer.prototype, "currentDuration",
{
    get: function()
    {
        if (!this.playing) return 0;
 ...
 */
VOPlayer.prototype.getElapsed = function()
{
    var total = 0,
        item, i;
 ...
 * @public
 */
VOPlayer.prototype.pause = function()
{
 ...
 * @public
 */
VOPlayer.prototype.resume = function()
{
 ...
 */
VOPlayer.prototype.play = function(idOrList, callback, cancelledCallback)
{
    this.stop();
 ...
 * @private
 */
VOPlayer.prototype._onSoundFinished = function()
{
 ...
 */
VOPlayer.prototype._updateSilence = function(elapsed)
{
    this._timer -= elapsed;
 ...
 * @param {int} elapsed The time elapsed since the previous frame, in milliseconds.
 */
VOPlayer.prototype._updateSoloCaption = function(elapsed)
{
    this._timer += elapsed;
 ...
 * @param {int} elapsed The time elapsed since the previous frame, in milliseconds.
 */
VOPlayer.prototype._syncCaptionToSound = function(elapsed)
{
 ...
 * @public
 */
VOPlayer.prototype.stop = function()
{
    this.paused = false;
    if (this._soundInstance)
    {
 ...
 * @public
 */
VOPlayer.prototype.unloadSound = function()
{
 ...
 * @public
 */
VOPlayer.prototype.destroy = function()
{
    this.stop();
    this.voList = null;
