...
-   `param` **[object][230]** 
    -   `param.offset` **[Point][231]** 
    -   `param.gameSize` **[Point][231]** 
...
-   `position` **[Point][231]** position relative to anchor direction
...
-   `scale` **[Point][231]** x/y scale values
...
Type: {offset: [Point][231], gameSize: [Point][231], scale: [Point][231]}
