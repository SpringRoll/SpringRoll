...
(function(undefined)
{
	...
	/**
	 *  Constructor for the button when using EaselJS.
	...
	Button.generateDefaultStates = function(image, disabledSettings, highlightSettings)
	{
		...
		if (disabledSettings)
		{
			...
			if (disabledSettings.brightness !== undefined)
				matrix.adjustBrightness(disabledSettings.brightness * 2.55); //convert to EaselJS's -255->255 system from -100->100
